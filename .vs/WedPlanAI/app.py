...
print(f"PROJECT_ID loaded: {PROJECT_ID}")
print(f"LOCATION loaded: {LOCATION}")
print(f"GCS_BUCKET_NAME loaded: {GCS_BUCKET_NAME}")
...
# Optional: Set Google ADC path for GCS/Vertex AI clients
...
try:
    ...
    print(f"Gemini Image Client initialized successfully for model: gemini-2.0-flash-exp-image-generation")
